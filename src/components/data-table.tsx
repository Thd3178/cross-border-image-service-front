...
import { RiDraggable, RiCheckboxCircleFill, RiLoader4Line, RiMore2Line, RiLayoutColumnLine, RiArrowDownSLine, RiAddLine, RiSkipLeftLine, RiArrowLeftSLine, RiArrowRightSLine, RiSkipRightLine, RiArrowUpLine } from "@remixicon/react"
...
function DragHandle({ id }: { id: number }) {
  ...
  return (
    ...
    >
      <RiDraggable className="size-3 text-muted-foreground" />
...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  },
  {
    ...
    header: "审核人",
    cell: ({ row }) => {
      const isAssigned = row.original.reviewer !== "分配审核人"
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            <SelectGroup>
              <SelectItem value="outline">概览</SelectItem>
        ...
        <TabsList className="hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:bg-muted-foreground/30 **:data-[slot=badge]:px-1 @4xl/main:flex">
          <TabsTrigger value="outline">概览</TabsTrigger>
